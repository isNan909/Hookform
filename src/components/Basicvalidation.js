            ...
            <div className="basicValidation">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="exampleInputEmail1" name="lastnamename" ref={register({ required: true })} placeholder="Your last name" />
                        {errors.firstname && <span>This field is required</span>}
                    </div>
                    <div className="form-group">
                    ...
                    <div>
                        <div className="custom-control flex custom-radio">
                            ...
                            <div className="flex">{errors.active && <span>This field is required</span>}</div>
